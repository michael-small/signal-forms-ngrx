...
@Component({
  ...
  template: `
    ...
    <ul>
      ...
      <li><a href="https://ngrx.io/guide/signals/signal-store" target="_blank">NgRx Signals</a></li>
      <li>
      ...
      <li>
        <a href="https://github.com/ngrx/platform/issues/5126" target="_blank"
          >RFC(@ngrx/signals): Resource Integration Part 1 - Introduce Extend Resource APIs</a
        >
      </li>
      <li>
        <a href="https://github.com/markostanimirovic/extend-resource-prototype" target="_blank"
