// From NgRx Signals PR: https://github.com/ngrx/platform/pull/5151

import { computed, untracked, ValueEqualityFn, WritableSignal } from '@angular/core';
 ...
 * ```
 */
export function delegatedSignal<T>(config: DelegatedSignalConfig<T>): WritableSignal<T> {
